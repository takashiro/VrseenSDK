		...
		LineIndex_t * indices, const int maxIndices )
{
    ...
    glVertexAttribPointer( LOCATION_POSITION, 3, GL_FLOAT, false, sizeof( LineVertex_t ), (void*)0 );

    glEnableVertexAttribArray( LOCATION_COLOR ); // color
    glVertexAttribPointer( LOCATION_COLOR, 4, GL_FLOAT, true, sizeof( LineVertex_t ), (void*)12 );
