#ifndef VREFERENCECOUNTED_H
#define VREFERENCECOUNTED_H
...
namespace NervGear
{
class VReferenceCounted
    {
    public:

        //! Constructor.
        VReferenceCounted()
            : DebugName(0), VeferenceCounter(1)
        {
        }

        //! Destructor.
        virtual ~VReferenceCounted()
        {
        }
        ...
        const VString getDebugName() const
        {
            return DebugName;
        }
    ...
    protected:
        ...
        void setDebugName(const VString newName)
        {
            DebugName = newName;
        }
