...
GLuint VGlShader::createProgram(GLuint vertexShader, GLuint fragmentShader)
{
    ...
    glBindAttribLocation( program, LOCATION_POSITION,		"Position" );
    glBindAttribLocation( program, LOCATION_NORMAL,			"Normal" );
    glBindAttribLocation( program, LOCATION_TANGENT,			"Tangent" );
    glBindAttribLocation( program, LOCATION_BINORMAL,		"Binormal" );
    glBindAttribLocation( program, LOCATION_COLOR,			"VertexColor" );
    glBindAttribLocation( program, LOCATION_UV0,				"TexCoord" );
    glBindAttribLocation( program, LOCATION_UV1,				"TexCoord1" );
    glBindAttribLocation( program, LOCATION_JOINT_WEIGHTS,	"JointWeights" );
    glBindAttribLocation( program, LOCATION_JOINT_INDICES,	"JointIndices" );
    glBindAttribLocation( program, LOCATION_FONT_PARMS,		"FontParms" );
