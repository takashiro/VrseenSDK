...
VGlGeometry CreateTimingGraphGeometry( const int lineVertCount )
{
    ...
    glVertexAttribPointer( LOCATION_POSITION, 2, GL_SHORT, false, sizeof( lineVert_t ), (void *)0 );

    glEnableVertexAttribArray( LOCATION_COLOR );
    glVertexAttribPointer( LOCATION_COLOR, 4, GL_UNSIGNED_BYTE, true, sizeof( lineVert_t ), (void *)4 );
    delete[] verts;
