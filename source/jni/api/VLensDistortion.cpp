                                                   ...
                                                   const bool cursorOnly)
{
    ...
    glVertexAttribPointer( LOCATION_POSITION, 2, GL_FLOAT, false, attribCount * sizeof( float ), (void *)( 0 * sizeof( float ) ) );

    glEnableVertexAttribArray( LOCATION_NORMAL );
    glVertexAttribPointer( LOCATION_NORMAL, 2, GL_FLOAT, false, attribCount * sizeof( float ), (void *)( 2 * sizeof( float ) ) );

    glEnableVertexAttribArray( LOCATION_UV0 );
    glVertexAttribPointer( LOCATION_UV0, 2, GL_FLOAT, false, attribCount * sizeof( float ), (void *)( 4 * sizeof( float ) ) );

    glEnableVertexAttribArray( LOCATION_TANGENT );
    glVertexAttribPointer( LOCATION_TANGENT, 2, GL_FLOAT, false, attribCount * sizeof( float ), (void *)( 6 * sizeof( float ) ) );

    glEnableVertexAttribArray( LOCATION_UV1 );
    glVertexAttribPointer( LOCATION_UV1, 2, GL_FLOAT, false, attribCount * sizeof( float ), (void *)( 8 * sizeof( float ) ) );
