...
{
	m_warpPrograms[ simpleIndex ] = BuildWarpProg( simpleVertex, simpleFragment );
	m_warpPrograms[ simpleIndex + ( WP_CHROMATIC - WP_SIMPLE ) ] = BuildWarpProg( chromaticVertex, chromaticFragment );
}
...
{
	m_warpPrograms[ simpleIndex ] = BuildWarpProg( simpleVertex, simpleFragment );
	m_warpPrograms[ simpleIndex + ( WP_CHROMATIC - WP_SIMPLE ) ] = BuildWarpProg( simpleVertex, simpleFragment );
}
