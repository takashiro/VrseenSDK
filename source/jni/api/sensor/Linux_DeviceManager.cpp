...
int DeviceManagerThread::Run()
{
    ...
    SetThreadName("NervGear::DeviceManagerThread");
    LogText("NervGear::DeviceManagerThread - running (ThreadId=%p).\n", GetThreadId());
    ...
    LogText("NervGear::DeviceManagerThread - exiting (ThreadId=%p).\n", GetThreadId());
    return 0;
}
