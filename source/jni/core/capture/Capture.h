...
#define OVR_CAPTURE_CREATE_LABEL(name)                                                 \
    static NervGear::Capture::Label _ovrcap_label_##name;                                   \
...
#define OVR_CAPTURE_CPU_ZONE(name)                                          \
    ...
    NervGear::Capture::CPUScope _ovrcap_cpuscope_##name(_ovrcap_label_##name);

#define OVR_CAPTURE_SENSOR_SET(name, value)                                 \
    if(NervGear::Capture::IsConnected())                                         \
    {                                                                       \
        OVR_CAPTURE_CREATE_LABEL(name);                                     \
        NervGear::Capture::SensorSetValue(_ovrcap_label_##name, value);          \
    }
...
namespace Capture
{
    ...
    class Label
    {
        ...
        public:
            ...
            inline UInt32 identifier(void) const
            {
                return m_identifier;
            }
        ...
        private:
            ...
            static Label *head(void);
            Label *next(void) const;
